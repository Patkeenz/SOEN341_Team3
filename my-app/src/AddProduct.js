        ...
        <div className="product">
          ...
          <form>
            <div className="inputSpace">
              ...
              <br/>
              <input id="name" className="textbox" type="text" name="name" placeholder="Product Name"/>
              <br/>
            </div>
            <div className="inputSpace">
              <label className="textboxLabel" for="priceText">Product Price</label>
              <br/>
              <input id="price" className="textbox" type="text" name="price" placeholder="Product Price"/>
              <br/>
            </div>
            <div className="inputSpace">
              <label className="textboxLabel" for="descriptionText">Product Description</label>
              <br/>
              <input id="description" className="textbox" type="text" name="description" placeholder="Product Description"/>
              <br/>
            </div>
            <div className="inputSpace">
              <select id="category">
